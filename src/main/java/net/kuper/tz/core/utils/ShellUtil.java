...
//        System.out.println(ShellUtil.execCommand("dir").toString());
//        System.out.println(ShellUtil.execCommand("ls -l").toString());
//        System.out.println(ShellUtil.execCommand("ping www.baidu.com").toString());
        System.out.println(ShellUtil.execCommand("aapt v").toString());
        System.out.println(ShellUtil.execCommand("aapt.exe").toString());
